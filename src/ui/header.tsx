        ...
        <header className="absolute inset-x-0 top-0 z-50">
            <nav aria-label="Global" className="flex items-center justify-between p-6 lg:px-8">
                ...
                <div className="flex lg:hidden">
                    <button type="button" data-command="show-modal" data-command-for="mobile-menu" className="-m-2.5 inline-flex items-center justify-center rounded-md p-2.5 text-gray-200">
                        ...
                        <div tabIndex={0} className="fixed inset-0 focus:outline-none">
                            <div className="fixed inset-y-0 right-0 z-50 w-full overflow-y-auto bg-gray-900 p-6 sm:max-w-sm sm:ring-1 sm:ring-gray-100/10">
                                <div className="flex items-center justify-between">
                                    ...
                                    <button type="button" data-command="close" data-command-for="mobile-menu" className="-m-2.5 rounded-md p-2.5 text-gray-200">
